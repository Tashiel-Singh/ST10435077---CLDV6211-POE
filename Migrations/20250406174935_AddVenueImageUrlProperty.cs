...
{
    /// <inheritdoc />
    public partial class AddVenueImageUrlProperty : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Venue__3C57E5F2C0E7ADCF", x => x.VenueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Event__7944C8104A316522", x => x.EventId);
                    table.ForeignKey(
                        name: "FK_Event_Venue",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Booking__73951AEDECB9C6CD", x => x.BookingId);
                    table.ForeignKey(
